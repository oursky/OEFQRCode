...
//: 3. Now you can create GIF QR code with `OEFQRCode.generateGIF` and get its data:
let qrcodeData = OEFQRCode.generateGIF(using: generator, withWatermarkGIF: data)
